...
public class PaymentRepositoryTest {
    ...
    void setUp(){
        ...
        Payment payment1 = new Payment("0176dc9d-3381-4b14-8705-8f66a8b86acf","VOUCHER_CODE", orders.get(1), paymentData1);
        payments.add(payment1);

        Map<String, String> paymentData2 = new HashMap<>();
        paymentData2.put("bankName", "BCA");
        paymentData2.put("referenceCode", "001");
        Payment payment2 = new Payment("563456ef-e9d3-490c-8309-043c926b80e4","PAYMENT_BY_BANK_TRANSFER", orders.get(2), paymentData2);
